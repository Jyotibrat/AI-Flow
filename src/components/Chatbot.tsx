...
// Allowed tags & attributes for safe formatting
const SAFE_TAGS = ["b", "i", "u", "strong", "em", "br"];
const SAFE_ATTR = [];
...
const Chatbot: React.FC = () => {
  ...
  const handleSend = async () => {
    ...
    const cleanInput = sanitizeMessage(inputValue);

    const userMessage = { type: "user", text: cleanInput };
    ...
    try {
      ...
      // Sanitize bot output before rendering
      const cleanBotText = sanitizeMessage(botText);
      setMessages((prev) => [...prev, { type: "bot", text: cleanBotText }]);
    } catch (error) {
      setMessages((prev) => [
        ...prev,
                ...
                {messages.map((message, index) => (
                  ...
                  >
                    <div
                      ...
                      // Render allowed HTML tags safely
